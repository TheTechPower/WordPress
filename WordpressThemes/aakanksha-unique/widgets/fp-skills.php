...
class aakanksha_Skills extends WP_Widget {

    function aakanksha_skills() {
		$widget_ops = array('classname' => 'aakanksha_skills_widget', 'description' => __( 'Show your visitors some of your skills.', 'aakanksha') );
        parent::__construct(false, $name = __('aakanksha FP: Skills', 'aakanksha'), $widget_ops);
		$this->alt_option_name = 'aakanksha_skills_widget';
    }
	...
	<!-- skill one -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_one'); ?>"><?php _e('First skill name', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_one_max'); ?>"><?php _e('First skill value', 'aakanksha'); ?></label>
	...
	<!-- skill two -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_two'); ?>"><?php _e('Second skill name', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_two_max'); ?>"><?php _e('Second skill value', 'aakanksha'); ?></label>
	...
	<!-- skill three -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_three'); ?>"><?php _e('Third skill name', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_three_max'); ?>"><?php _e('Third skill value', 'aakanksha'); ?></label>
	...
	<!-- skill four -->
	<p>
	<label for="<?php echo $this->get_field_id('skill_four'); ?>"><?php _e('Fourth skill name', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('skill_four_max'); ?>"><?php _e('Fourth skill value', 'aakanksha'); ?></label>
	...
	function update($new_instance, $old_instance) {
		...
		if ( isset($alloptions['aakanksha_skills']) )
			delete_option('aakanksha_skills');		  
	...
	function widget($args, $instance) {
		$cache = array();
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'aakanksha_skills', 'widget' );
		}
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'aakanksha_skills', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	}
