...
class aakanksha_Facts extends WP_Widget {

// constructor
    function aakanksha_facts() {
		$widget_ops = array('classname' => 'aakanksha_facts_widget', 'description' => __( 'Show your visitors some facts about your company.', 'aakanksha') );
        parent::__construct(false, $name = __('aakanksha FP: Facts', 'aakanksha'), $widget_ops);
		$this->alt_option_name = 'aakanksha_facts_widget';
    }
	...
	?>
	<p><?php _e('You can find a list of the available icons ', 'aakanksha'); ?><a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_blank"><?php _e('here.', 'aakanksha'); ?></a>&nbsp;<?php _e('Usage example: <strong>fa-android</strong>', 'aakanksha'); ?></p>
	<p>
	<label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', 'aakanksha'); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id('title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo $title; ?>" />
	</p>

	<!-- fact one -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_one'); ?>"><?php _e('First fact name', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_one_max'); ?>"><?php _e('First fact value', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_one_icon'); ?>"><?php _e('First fact icon', 'aakanksha'); ?></label>
	...
	<!-- fact two -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_two'); ?>"><?php _e('Second fact name', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_two_max'); ?>"><?php _e('Second fact value', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_two_icon'); ?>"><?php _e('Second fact icon', 'aakanksha'); ?></label>
	...
	<!-- fact three -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_three'); ?>"><?php _e('Third fact name', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_three_max'); ?>"><?php _e('Third fact value', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_three_icon'); ?>"><?php _e('Third fact icon', 'aakanksha'); ?></label>
	...
	<!-- fact four -->
	<p>
	<label for="<?php echo $this->get_field_id('fact_four'); ?>"><?php _e('Fourth fact name', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_four_max'); ?>"><?php _e('Fourth fact value', 'aakanksha'); ?></label>
	...
	<p>
	<label for="<?php echo $this->get_field_id('fact_four_icon'); ?>"><?php _e('Fourth fact icon', 'aakanksha'); ?></label>
	...
	function update($new_instance, $old_instance) {
		...
		if ( isset($alloptions['aakanksha_facts']) )
			delete_option('aakanksha_facts');		  
	...
	function widget($args, $instance) {
		$cache = array();
		if ( ! $this->is_preview() ) {
			$cache = wp_cache_get( 'aakanksha_facts', 'widget' );
		}
...
?>
	...
	<?php
		...
		if ( ! $this->is_preview() ) {
			...
			wp_cache_set( 'aakanksha_facts', $cache, 'widget' );
		} else {
			ob_end_flush();
		}
	}
