...
// 	COUNTER BLOCK
if(!class_exists('as_Counter_Block')) :

class as_Counter_Block extends as_Block {
	
	function __construct() {
		$block_options = array(
			'name' => __('AT Counter', 'aakanksha'),
			'size' => 'span12',
		);
	...
	function form($instance) {
		...
		<p class="description">
			<label for="<?php echo $this->get_field_id('column') ?>">
				...
				<?php echo as_field_select('column', $block_id, $counter_columns, $column) ?>
			</label>
		</p>
		<p class="description">
		...
		<div class="description cf">
			...
			<p></p>
			<a href="#" rel="counter" class="as-sortable-add-new button"><?php _e('Add New', 'aakanksha') ?></a>
			<p></p>
		</div>
		<?php
	}
			...
			<div class="sortable-body">
				...
				<p class="counters-desc description">
					...
					<label for="<?php echo $this->get_field_id('counters') ?>-<?php echo $count ?>-interval">
						<?php _e('Refresh interval', 'aakanksha') ?>
				...
				<p class="counter-desc description"><a href="#" class="sortable-delete"><?php _e('Delete', 'aakanksha') ?></a></p>
			</div>
