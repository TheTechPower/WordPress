...
// CLEAR BLOCK
if( ! class_exists( 'as_Testimonial_Block' ) ) :

class as_Testimonial_Block extends as_Block {

	function __construct() {
		$block_options = array(
			'name' => __( 'AT Testimonials', 'aakanksha'),
			'size' => 'span12',
		);
		...
		?>
			<div class="item">
            	<div class="image-testimonial-wrapper">
					<a href="#">
						<?php the_post_thumbnail( 'full', array('class' => 'at-post-thumbnail img-responsive','title'=> get_the_title()) ); ?>
					</a>
                </div>
			</div>
		<?php
