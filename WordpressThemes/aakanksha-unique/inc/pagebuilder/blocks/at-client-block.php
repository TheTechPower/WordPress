...
// LIST BLOCK
if(!class_exists('as_List_Block')) :

class as_List_Block extends as_Block {
	...
	function __construct() {
		...
		//create the widget
		parent::__construct('as_List_Block', $block_options);
		
		//add ajax functions
		add_action('wp_ajax_as_block_list_item_add_new', array($this, 'add_list_item'));
	...
	function form($instance) {
        ...
        <p class="description">
			<label for="<?php echo $this->get_field_id('column') ?>">
				...
				<?php echo as_field_select('column', $block_id, $client_columns, $column) ?>
			</label>
		</p>
		<div class="description cf">
			...
			<p></p>
			<a href="#" rel="list_item" class="as-sortable-add-new button">Add New</a>
			<p></p>
		</div>
		<?php
	}
			...
			<div class="sortable-body">
				...
				<p class="list_item-desc  description">
					<label for="<?php echo $this->get_field_id('list_items') ?>-<?php echo $count ?>-src_img">
						...
						<a href="#" class="as_upload_button button" rel="image">Upload</a><p></p>
					</label>
				</p>
				<p class="list_items-desc description">
					<label for="<?php echo $this->get_field_id('list_items') ?>-<?php echo $count ?>-animation">
						Animation style
						<?php echo as_field_select_in($this->get_field_id('list_items').'-'.$count.'-animation', $this->get_field_name('list_items').'['.$count.'][animation]', $include_animation, $list_item['animation']) ?>
					</label>
			  </p>
			  <p class="list_items-desc description">
...
as_register_block( 'as_List_Block' );
