...
// SOCIAL BLOCK
if( ! class_exists( 'as_Social_Block' ) ) :

class as_Social_Block extends as_Block {
	...
	function __construct() {
		...
		//create the block
		parent::__construct('as_Social_Block', $block_options);
	}
	...
	function form($instance) {
		...
		<p class="description">
            <label for="<?php echo $this->get_field_id('align') ?>">
                Text align<br/>
                <?php echo as_field_select('align', $block_id, $text_align , $align) ?>
            </label>
        </p>
        <div class="sortable-body">
            <p class="description">
                <label for="<?php echo $this->get_field_id('facebook_check') ?>">
                    ...
                    <?php echo as_field_checkbox('facebook_check', $block_id, $facebook_check) ?>
                </label>
            </p>
        	<p class="description">
                <label for="<?php echo $this->get_field_id('facebook_url') ?>">
                    Your facebook URL
                    <?php echo as_field_input('facebook_url', $block_id, $facebook_url, $size = 'full') ?>
            	</label>
            </p>
      	</div>
        ...
        <div class="sortable-body">
            <p class="description">
                <label for="<?php echo $this->get_field_id('twitter_check') ?>">
                    ...
                    <?php echo as_field_checkbox('twitter_check', $block_id, $twitter_check) ?>
                </label>
            </p>
        	<p class="description">
                <label for="<?php echo $this->get_field_id('twitter_url') ?>">
                    Your twitter URL
                    <?php echo as_field_input('twitter_url', $block_id, $twitter_url, $size = 'full') ?>
            	</label>
            </p>
      	</div>
        ...
        <div class="sortable-body">
            <p class="description">
                <label for="<?php echo $this->get_field_id('google_check') ?>">
                    Display google+ icon ?
                    <?php echo as_field_checkbox('google_check', $block_id, $google_check) ?>
                </label>
            </p>
        	<p class="description">
                <label for="<?php echo $this->get_field_id('google_url') ?>">
                    Your google URL
                    <?php echo as_field_input('google_url', $block_id, $google_url, $size = 'full') ?>
            	</label>
            </p>
      	</div>
        ...
        <div class="sortable-body">
            <p class="description">
                <label for="<?php echo $this->get_field_id('pinterest_check') ?>">
                    ...
                    <?php echo as_field_checkbox('pinterest_check', $block_id, $pinterest_check) ?>
                </label>
            </p>
        	<p class="description">
                <label for="<?php echo $this->get_field_id('pinterest_url') ?>">
                    Your pinterest URL
                    <?php echo as_field_input('pinterest_url', $block_id, $pinterest_url, $size = 'full') ?>
            	</label>
            </p>
      	</div>
        ...
        <div class="sortable-body">
            <p class="description">
                <label for="<?php echo $this->get_field_id('dribbble_check') ?>">
                    ...
                    <?php echo as_field_checkbox('dribbble_check', $block_id, $dribbble_check) ?>
                </label>
            </p>
        	<p class="description">
                <label for="<?php echo $this->get_field_id('dribbble_url') ?>">
                    Your dribbble URL
                    <?php echo as_field_input('dribbble_url', $block_id, $dribbble_url, $size = 'full') ?>
            	</label>
            </p>
      	</div>
        ...
        <div class="sortable-body">
            <p class="description">
                <label for="<?php echo $this->get_field_id('flickr_check') ?>">
                    Display flickr icon ?
                    <?php echo as_field_checkbox('flickr_check', $block_id, $flickr_check) ?>
                </label>
            </p>
        	<p class="description">
                <label for="<?php echo $this->get_field_id('flickr_url') ?>">
                    Your flickr URL
                    <?php echo as_field_input('flickr_url', $block_id, $flickr_url, $size = 'full') ?>
            	</label>
            </p>
      	</div>
        ...
        <div class="sortable-body">
            <p class="description">
                <label for="<?php echo $this->get_field_id('linkedin_check') ?>">
                    ...
                    <?php echo as_field_checkbox('linkedin_check', $block_id, $linkedin_check) ?>
                </label>
            </p>
        	<p class="description">
                <label for="<?php echo $this->get_field_id('linkedin_url') ?>">
                    Your linkedin URL
                    <?php echo as_field_input('linkedin_url', $block_id, $linkedin_url, $size = 'full') ?>
            	</label>
            </p>
      	</div>
...
as_register_block( 'as_Social_Block' );
endif;