...
<?php 
	// Get sharing options
		$sharing_sites  = get_theme_mod('social_share_blog');
...
<div class="blog-header-wrapper">
	<?php 
		...
		$img		= has_post_thumbnail($post->ID) ? wp_get_attachment_url( get_post_thumbnail_id($post->ID) ) : get_theme_mod('header_blog_img', false, 'url');
                ...
                <div calss="logo-wrapper">
                    <div class="logo">
                         <a href="<?php echo home_url(); ?>">
                            ...
                            ?>
                                <div class="logo-img logo-white"><span>A</span></div>
                            <?php } ?>
                         </a>
                    </div>  
                </div>
    ...
    <div class="container single-blog-mobile">
        <div class="row">
            <div class="col-md-1 col-xs-2  single-blog-mobile at-post-data-left single-blog">
...
<div class="container">
	<div class="row">
    	<div class="single-blog-desktop">
            <div class="col-md-1 col-sm-1 at-post-data-left single-blog">
                <a href="<?php echo home_url(); ?>" class="home-icon"><i class="fa fa-home"></i></a>
                <span class="at-post-month"><?php the_time('M');?></span>
                <span class="at-post-date"><?php the_time('d');?></span>
                <a href="#" data-id="<?php echo $post->ID; ?>" class="at-like-post <?php echo is_like_post($post->ID); ?>">
...
<div class="next-post-container" style="background-image:url(<?php echo has_post_thumbnail($next_post->ID) ? wp_get_attachment_url( get_post_thumbnail_id($next_post->ID) ) : get_theme_mod('header_blog_img', false, 'url'); ?>)">    
